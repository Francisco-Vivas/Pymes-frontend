...
export default function MainLayout({children}){
 ...
 <Layout>
    <Header className="header" style={{backgroundColor: "#164166"}}>
      <div className="logo" />
      <Menu theme="dark" mode="horizontal" style={{backgroundColor: "#164166", }}>
        <Menu.Item key="1" style={{color:"#dce9ed"}}>Log In</Menu.Item>
        <Menu.Item key="2" style={{color:"#dce9ed"}}>Sign Up</Menu.Item>
        <Menu.Item key="3" style={{color:"#dce9ed"}}>Log Out</Menu.Item>
      </Menu>
    </Header>
    <Layout>
      <Sider width={200} className="site-layout-background">
        ...
        >
          {/* <SubMenu key="sub1" title="subnav 1"> */}
            ...
            <Menu.Item key="6" style={{color:"#164166"}}>Social</Menu.Item>
          {/* </SubMenu> */}
        </Menu>
      </Sider>
